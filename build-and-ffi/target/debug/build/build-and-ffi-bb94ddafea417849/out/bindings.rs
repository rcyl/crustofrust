...
pub const SODIUM_VERSION_STRING: &[u8; 7usize] = b"1.0.18\0";
...
pub const crypto_kdf_PRIMITIVE: &[u8; 8usize] = b"blake2b\0";
...
pub const crypto_pwhash_argon2i_STRPREFIX: &[u8; 10usize] = b"$argon2i$\0";
...
pub const crypto_pwhash_argon2id_STRPREFIX: &[u8; 11usize] = b"$argon2id$\0";
...
pub const crypto_pwhash_STRPREFIX: &[u8; 11usize] = b"$argon2id$\0";
...
pub const crypto_pwhash_PRIMITIVE: &[u8; 8usize] = b"argon2i\0";
...
pub const crypto_shorthash_PRIMITIVE: &[u8; 10usize] = b"siphash24\0";
...
pub const crypto_pwhash_scryptsalsa208sha256_STRPREFIX: &[u8; 4usize] = b"$7$\0";
...
fn bindgen_test_layout_crypto_aead_aes256gcm_state_() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_aead_aes256gcm_state_> =
...
fn bindgen_test_layout_crypto_hash_sha512_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_hash_sha512_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_auth_hmacsha512_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_auth_hmacsha512_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ictx) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).octx) as usize - ptr as usize },
        208usize,
        concat!(
            "Offset of field: ",
            stringify!(crypto_auth_hmacsha512_state),
...
fn bindgen_test_layout_crypto_hash_sha256_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_hash_sha256_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_auth_hmacsha256_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_auth_hmacsha256_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_generichash_blake2b_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_onetimeauth_poly1305_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_onetimeauth_poly1305_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_secretstream_xchacha20poly1305_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_secretstream_xchacha20poly1305_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
fn bindgen_test_layout_crypto_sign_ed25519ph_state() {
    const UNINIT: ::std::mem::MaybeUninit<crypto_sign_ed25519ph_state> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).hs) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_randombytes_implementation() {
    const UNINIT: ::std::mem::MaybeUninit<randombytes_implementation> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).implementation_name) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
